...
const pallette = (navType: PaletteMode, presetColor: string) => {
    ...
    return createTheme({
        palette: {
            ...
            primary: {
                ...
                600: navType === 'dark' ? colors.primaryButonLoginDark : colors.primaryButtonLogin,
                700: navType === 'dark' ? colors.primaryButonLogin : colors.primaryButonLoginDark
            },
            secondary: {
